...
},{"./bundle-url":"../../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../css/typed.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../../node_modules/typed.js/lib/typed.js":[function(require,module,exports) {
var define;
/*!
 * 
...
;
},{}],"src/block.jsx":[function(require,module,exports) {
"use strict";

require("../../css/typed.scss");
  ...
  function (_Component) {
    ...
    _createClass(edit, [{
      ...
      value: function addString() {
        var strings = this.props.attributes.strings.slice();
      ...
      key: "removeString",
      value: function removeString(index) {
        var strings = this.props.attributes.strings.slice();
      ...
      key: "onStringChange",
      value: function onStringChange(index, string) {
        var strings = this.props.attributes.strings.slice();
      ...
      value: function onAttributeChange(key, value) {
        var v = {};
        v[key] = value;
      ...
      key: "onInputChange",
      value: function onInputChange(key, value, a) {
      ...
      value: function render() {
        ...
        return React.createElement(Fragment, null, React.createElement(InspectorControls, null, React.createElement(PanelBody, {
          ...
          return React.createElement("div", {
            ...
            value: string,
            onChange: _this2.onStringChange.bind(_this2, index)
          }), React.createElement(IconButton, {
            icon: "trash",
            value: __('Remove string'),
            onClick: _this2.removeString.bind(_this2, index)
          }));
        }), React.createElement(Button, {
          isDefault: true,
          className: "add-more",
          onClick: this.addString
        }, __('Add string'))), React.createElement(PanelBody, {
          title: __('Effect settings'),
          className: "effect-settings"
        }, attributeKeys.map(function (key) {
          // From camelCase to -> camel Case
          var camel = key.split(/(?=[A-Z])/).join(' ');
          var label = camel.charAt(0).toUpperCase() + camel.slice(1); // capitalise first letter.
...
},{"../../css/typed.scss":"../css/typed.scss","typed.js":"../../node_modules/typed.js/lib/typed.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/block.jsx"], null)
